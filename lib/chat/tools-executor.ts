...
const TOOL_ROUTER: Record<string, ToolHandler> = {
  ...{
    'memoria_buscar_longa': (p, a, n) => Memory.executeBuscarMemoriaLonga(p, a, n),
    'memoria_adicionar_diretriz': (p, a, n) => Memory.executeAdicionarDiretrizDinamica(p, a, n),
    'gerenciar_guideline': (p, a, n) => Guidelines.executeGerenciarGuideline(p, a, n),
  },
  ...{
    'agenda_consultar': (p, a, n) => Agenda.executeConsultarAgenda(p, a, n),
    'agenda_salvar_evento': (p, a, n, s) => Agenda.executeSalvarEvento(p, a, n, s),
    'agenda_deletar_evento': (p, a, n, s) => Agenda.executeDeletarEvento(p, a, n, s),
  },
  ...{
    'lembrete_consultar': (p, a, n) => Reminders.executeConsultarLembretes(p, a, n),
    'lembrete_criar': (p, a, n, s) => Reminders.executeCreateReminder(p, a, n, s),
    'lembrete_cancelar': (p, a, n, s) => Reminders.executeCancelarLembrete(p, a, n, s),
  },
  ...{
  ...
  ...{
    ...
    'veiculo_registrar_manutencao': (p, a, n) => Veiculos.executeRegistrarManutencao(p, a, n),
    'veiculo_atualizar_odometro': (p, a, n) => Veiculos.executeAtualizarOdometro(p, a, n),
  },
  ...{
    'lugar_salvar': (p, a, n) => Lugares.executeSalvarLugar(p, a, n),
    'compra_adicionar_item': (p, a, n) => Compras.executeAdicionarItemLista(p, a, n),
    'compra_ver_lista': (p, a, n) => Compras.executeVerLista(p, a, n),
    'compra_marcar_comprado': (p, a, n) => Compras.executeMarcarItemComprado(p, a, n),
    'compra_listar_projeto': (p, a, n) => Compras.executeListarComprasProjeto(p, a, n),
  },
  ...{
    'tdah_gerenciar_eisenhower': (p, a, n) => TDAH.executeGerenciarEisenhower(p, a, n),
    'tdah_quebrar_tarefa': (p, a, n) => TDAH.executeQuebrarTarefa(p, a, n),
    'tdah_registrar_despejo_mental': (p, a, n) => TDAH.executeRegistrarDespejo(p, a, n),
    'tdah_registrar_sessao_foco': (p, a, n) => TDAH.executeRegistrarSessaoFoco(p, a, n),
    'tdah_consultar_resumo': (p, a, n) => TDAH.executeConsultarResumoFoco(p, a, n),
  },
  ...{
    'listar_rotinas': (p, a, n) => Rotinas.executeListarRotinas(p, a, n),
    'gerenciar_rotina': (p, a, n) => Rotinas.executeGerenciarRotina(p, a, n),
    'fazer_checkin_rotina': (p, a, n) => Rotinas.executeFazerCheckinRotina(p, a, n),
  },
  ...{
    'financas_registrar_transacao': (p, a, n) => Financas.executeRegistrarTransacao(p, a, n),
    'financas_consultar': (p, a, n) => Financas.executeConsultarFinancas(p, a, n),
    'financas_criar_orcamento': (p, a, n) => Financas.executeCriarOrcamento(p, a, n),
    'financas_listar_orcamentos': (_, a, n) => Financas.executeListarOrcamentos(a, n),
  },
  ...{
    'projeto_gerenciar': (p, a, n) => Projects.executeGerenciarProjeto(p, a, n),
    'projeto_listar': (p, a, n) => Projects.executeListarProjetos(p, a, n),
    'projeto_gerenciar_topico': (p, a, n) => Projects.executeGerenciarTopico(p, a, n),
    'projeto_listar_topicos': (p, a, n) => Projects.executeListarTopicos(p, a, n),
    'projeto_gerenciar_entry': (p, a, n) => Projects.executeGerenciarEntry(p, a, n),
    'projeto_listar_entries': (p, a, n) => Projects.executeListarEntries(p, a, n),
    'projeto_gerenciar_membros': (p, a, n) => Projects.executeGerenciarMembrosProjeto(p, a, n),
  },
  ...{
  ...
  ...{
    'dossie_atualizar': (p, a, n) => Dossie.executeAtualizarDossie(p, a, n),
    'dossie_consultar': (p, a, n) => Dossie.executeConsultarDossie(p, a, n),
    'personalidade_ajustar': (p, a, n) => Personality.executeAjustarPersonalidade(p, a, n),
    'personalidade_consultar': (p, a, n) => Personality.executeConsultarPersonalidade(p, a, n),
  }
};
