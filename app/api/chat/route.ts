...
export const maxDuration = 30; // Aumentado para 30 segundos
...
async function callOpenRouterWithTools(messages: any[], toolsDef: any[], model: string, temperature: number, timeoutMs = 25000): Promise<ToolResponse> {
